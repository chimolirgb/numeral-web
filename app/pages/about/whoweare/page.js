                      ...
                      <div className={styles.cardsContainer}>
                        <div className={styles.card}>
                          <p>
                            ...
                            customers connect and manage their devices, as well
                            as solutions that help them analyse and make use of
                            the data generated by those devices.
                          </p>
                        </div>
                        <div className={styles.card}>
                          <p>
                            2- Quality and reliability: We commit to provide
                            excellent customer service and support to help
                            customers get the most out of their IoT solutions.
                          </p>
                        </div>
                        <div className={styles.card}>
                          <p>
                            3- Transparency: We are open about how our products
                            and services work. We empower our customers by
                            providing them with the tools and support they need
                            to succeed in their own IoT projects.
                          </p>
                        </div>
                        <div className={styles.card}>
                          <p>
